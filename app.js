/* Una funcion es un encapsulamiento de la accion que queremos que haga. 
Entonces en el html en lugar de escribir todo el codigo de javascipt solo llamamos la function. 
*/
...
function verificarIntento() {
    ...
    // El triple igual compara teniendo en cuenta tanto el valor como el tipo de dato
...
function generarNumeroSecreto() {
    ...
    if (listaNumerosSorteados.length == numeroMaximo) {
     ...
     //Si el número generado esta inlcuido en la lista
